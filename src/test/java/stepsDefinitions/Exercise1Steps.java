...
public class Exercise1Steps {
    ...
    public void userSingIn() {
        ...
        driver.findElement(By.id("field-email")).sendKeys("katarzynakaczmarek392@gmail.com");
        driver.findElement(By.id("field-password")).sendKeys("blablabla");
    ...
    public void enterDataAboutNewAddress (String alias,String address,String city,String zipCode, String country,String phone){
    ...
    public void addedAddress(String alertText){
        WebElement succesAlert =driver.findElement(By.className("alert alert-success"));
